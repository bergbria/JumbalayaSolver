...
{
    [TestClass]
    public class SlightlyLessFancyWordIndexTest1
    {
        private GenericWordIndexTests<SlightlyLessFancyWordIndex> _tester;

        [TestInitialize]
        public void Setup()
        {
            _tester = new GenericWordIndexTests<SlightlyLessFancyWordIndex>();
            _tester.Setup();
        }
